    ...
    <div className="text-center font-sans flex flex-col items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200  ">
      <div className="flex justify-center items-center gap-8 py-6">
        <a href="https://vite.dev" target="_blank" rel="noopener noreferrer">
          <img src={viteLogo} className="w-24 h-24 hover:drop-shadow-xl transition-transform duration-300 hover:scale-110" alt="Vite logo" />
        </a>
        <a href="https://react.dev" target="_blank" rel="noopener noreferrer">
          <img src={reactLogo} className="w-24 h-24 hover:drop-shadow-xl transition-transform duration-300 hover:scale-110" alt="React logo" />
        </a>
      </div>
      ...
      <div className="bg-white dark:bg-[#1a1a1a] rounded-xl p-8 shadow-md inline-block">
        ...
        <p className="mt-4 text-gray-700 dark:text-gray-300">
          Edit <code className="bg-gray-100 dark:bg-gray-800 px-1 py-0.5 rounded">src/App.jsx</code> and save to test HMR
        </p>
      </div>
